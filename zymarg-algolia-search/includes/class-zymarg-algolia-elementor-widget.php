...
class Zymarg_Algolia_Elementor_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'category_scope',
			array(
				'label'        => __( 'Category scope filter', 'zymarg-algolia' ),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'description'  => __( 'When ON, a row of category pills appears above the results. The user can tap a category (e.g. "Electronics") to scope all subsequent searches to that category — like Shopee / Lazada. Tap again to clear the scope.', 'zymarg-algolia' ),
				'label_on'     => __( 'On', 'zymarg-algolia' ),
				'label_off'    => __( 'Off', 'zymarg-algolia' ),
				'default'      => '',
				'return_value' => 'yes',
